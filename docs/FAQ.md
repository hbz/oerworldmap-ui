...
<Accordion title="Who is this website for?" >
...
<Accordion title="How can I participate?" >
...
<Accordion title="How can I input and edit data?" >
...
<Accordion title="What belongs on the OER World Map?" >
...
<Accordion title="What do I have to keep in mind when I set a lighthouse?" >
...
<Accordion title="Where are the OER?" >
...
<Accordion title="What is an open license?" >
...
<Accordion title="Can I add services which provide non open resources to the map?" >
...
<Accordion title="Should MOOCs (Massive Open Online Courses) be added to the OER World Map?" >
...
<Accordion title="How will you use any information I share?" >
...
<Accordion title="How can I contribute stories?" >
...
<Accordion title="Do you want to hear from students as well as educators?" >
...
<Accordion title="What does it mean to become a country champion?" >
...
<Accordion title="Will the OER World Map be available in several languages?" >
...
<Accordion title="Why are countries displayed in different shades of green?" >
